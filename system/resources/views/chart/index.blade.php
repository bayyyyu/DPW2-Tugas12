...
<body>
    ...
    <table>
		  ...
		  <tr>
            @foreach($list_produk->sortBy('harga')->take('1') as $produk)
			<td class="ring-in"><a href="{{url('products', $produk->id) }}" class="at-in"><img src="{{url("public",$produk->foto)}}" class="img-responsive" alt=""></a>
			<div class="sed">
				<h5>{!! substr(nl2br ($produk->nama),0,60,) !!}.....</h5>
